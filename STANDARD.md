...
- Spend is the cost the provider reports for each call, summed per entry per UTC day. A call the provider billed counts even when it then fails or its reply is rejected.
